<template>
  <div class="container">
    ...
    <p>
      ...
      <a href="https://unpkg.com/terminal.css@0.7.1/dist/terminal.min.css">CDN</a>
    </p>
      ...
      <main>
        <section>
          <header>
            ...
            <p>Terminal CSS has no build-in grid system. However, you can roll your own with Flexbox or CSS Grid.</p>
          </header>
        ...
        <section>
          ...
          <p>
            A
            <strong>Table of content</strong>, which can be used as an index for a blog archive.
          </p>
          <p>
...
<span class="hljs-selector-class">.hljs-strong</span> {
  ...
  .custom-dl dd.italic {
    font-style: italic;
              ...
              <dd>
                Use
                <code>@font-face</code> or any other font provider to include your custom fonts.
              </dd>
          ...
          <section>
            ...
            <dl class="custom-dl">
              ...
              <dd>
                Use
                <code>&lt;body class="terminal"&gt;</code>. If you leave that option, it will fallback to browser defaults. See
                <a href="/sans-serif/">here</a>.
              </dd>
            </dl>
          </section>
        </section>
